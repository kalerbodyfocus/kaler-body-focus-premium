          ...
          <Reveal>
            <div className="flex flex-col items-start">
              ...
              <div className="mt-6 flex items-center gap-3">
                <div className="text-5xl font-display font-black text-white leading-none">5.0</div>
                <div>
              ...
              <a
                ...
                className="btn-gold btn-gold-hover mt-6 inline-flex items-center text-xs !py-2.5 !px-6 rounded-full font-bold uppercase tracking-wider"
              >
